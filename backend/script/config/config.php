...
$config["script_url"] = "http://inbas.mx/backend/";
/************************ database ************************/
//Set the host name to connect for database
$config["hostname"] =  "localhost";
//Set the database name
$config["database"] = "inbasmx_martaisa_inbas";
//Set the username for database access
$config["username"] = "inbasmx_bowar";
//Set the pwd for the database user
$config["password"] = "Sanchez2020+";
...
$config["purchase_code"] = "49dc249a-8fd3-4956-8cb0-5e5ae9adff03";
