...
if ($db) {
    ...
    echo 'Database connecting error! Please check your connection parameters.<br />';
}
?>
<center>
...
<a href="../" class="btn-success btn"><i class="fas fa-arrow-circle-right"></i> Continue to Project SECURITY</a>
</center>
<?php
footer();
?>