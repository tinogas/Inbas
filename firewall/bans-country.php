...
while ($rowbc = $querybc->fetch_assoc()) {
    ...
    echo '</td>
											...
											<td>
                                            <a href="?edit-id=' . $rowbc['id'] . '" class="btn btn-flat btn-primary"><i class="fas fa-edit"></i> Edit</a>
                                            <a href="?delete-id=' . $rowbc['id'] . '" class="btn btn-flat btn-success"><i class="fas fa-trash"></i> Delete</a>
											</td>
										</tr>
';
}
