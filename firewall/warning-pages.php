						 ...
						 <div class="card-header"><i class="fas fa-file-alt"></i> Warning Pages</div>
								...
								<ul class="nav flex-column nav-pills">
									<li class="nav-item active">
										<a class="nav-link active" data-toggle="tab" href="#sqli-layout"><i class="fas fa-bug"></i> SQL Injection</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#proxy-layout"><i class="fas fa-globe"></i> Proxy</a>
									</li>
                                    <li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#spam-layout"><i class="fas fa-keyboard"></i> Spam</a>
									</li>
									<li class="nav-item">
