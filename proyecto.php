...
<div class="container">
  ...
  <center>
      ...
      <img style='max-width: 75%;padding-top: 18px;' class="img-fluid" src="<?php echo $imagen?>" alt="">
      </center>
    </div>
...
<p style="font-size:18px;text-align:justify;"><?php echo utf8_encode($cliente)?></p>
       <?php
       }?> 
...
<?php if($fin=='actual'){
       ...
       ?>
 <h3 class="my-3">Plazo Ejecución</h3>
